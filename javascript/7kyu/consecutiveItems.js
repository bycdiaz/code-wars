...
// whether or not a and b appear consecutively in arr, and return a boolean value (True if a and
// b are consecutive, False otherwise).

// It is guaranteed that a and b are both present in arr.

function consecutive(arr, a, b) {
  const ifIndexesWithinOne = Math.abs(arr.indexOf(a) - arr.indexOf(b)) === 1;

  return ifIndexesWithinOne;
}
