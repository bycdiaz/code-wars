...
# input is either true or false, and whose output is the string representation of the input, either "true"/"True" or "false"/"False" 
# (check the sample tests about what capitalization to use in a given language).
...
# For this kata, don't worry about edge cases like where unexpected input is passed to the function. You'll get to worry about these 
# enough in later exercises.

def boolean_to_string(b) b ? "true" : "false" end
