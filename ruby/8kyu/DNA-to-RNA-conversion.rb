...
# DNA its chemical structure and contains no Thymine. In RNA Thymine is replaced by another 
...
# guaranteed to be valid, i.e. each input string will only ever consist of 'G', 'C', 'A' and/or 'T'.
