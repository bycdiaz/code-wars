...
# find_2nd_largest([1,1,1,1,1]) => nil because all elements are same. Largest no. is 1. and 
# there is no 2nd largest no.

# find_2nd_largest([1,'a','2',3,3,4,5,'b']) => 4 as after rejecting non integers array will 
# be [1,3,3,4,5] Largest no. is 5. and 2nd largest is 4.
