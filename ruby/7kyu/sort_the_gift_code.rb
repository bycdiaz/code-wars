...
# assigning a unique alphabetical character to each gift. After each gift was 
# assigned a character, the gift organizer Elf then joined the characters to form 
# the gift ordering code.
...
# Sort the Gift Code
# Write a function called sortGiftCode/sort_gift_code/SortGiftCode that accepts a 
# string containing up to 26 unique alphabetical characters, and returns a string 
